 ...
 */
// Changes on delta calculating
internal class CupertinoPullToRefreshOverscrollEffect(
    ...
    private fun availableDelta(delta: Offset, source: CupertinoScrollSource): Offset {
        ...
        // CHANGED HERE
        val (y, overscrollY) = availableDelta(delta.y, overscrollOffset.y.coerceAtMost(0f), source)
